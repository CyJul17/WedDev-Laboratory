...
<body>
    ...
    <?php
        ...
        function computePizzaTotal($pizza_price, $topping_prices, $qty) {
           $toppings_total = 0;
           if (!empty($topping_prices)) {
                foreach($topping_prices as $topping) {
                    $toppings_total += $topping;
                }
           }
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            ...
                            //TODO: 2. Add functionality for pizza options
                             ...
                             <?php
                                  foreach($pizzaMenu as $menuPizza => $price) {
                                    echo "<div class='radio-item'>";
                                    echo "<input type='radio' name='pizza' value='$menuPizza' id='$menuPizza' required>";
                                    echo "<label for='$menuPizza'>$menuPizza <span class='price'>₱$price</span></label>";
                                    echo "</div>";
                                  }
                            ?>
                            </div>
                            ...
                            // TODO: 3. Add functionality for toppings options
                              <?php
                                  foreach($toppingsMenu as $topping => $price) {
                                    ...
                                    echo "<input type='checkbox' id='topping-id' name='toppings[]' value='$topping'>";
                                    echo "<label for='$topping'>$topping <span class='price'>₱$price</span></label>";
                                    echo "</div>";
                                  }
                            ?>
                            </div>
            ...
            <div class="card">
                ...
                <?php
                    if (isset($_POST['order'])) {
                        ...
                        $pizza_price = $pizzaMenu[$pizza];

                        $topping_prices = [];
                        foreach ($toppings as $topping) {
                            $topping_prices[] = $toppingsMenu[$topping];
                        }
                        $grand_total = computePizzaTotal($pizza_price, $topping_prices, $qty);
                        ...
                        if(!empty($toppings)) {
                            foreach($toppings as $topping) {
                                ...
                                echo "<div class='summary-item'><span>Topping:</span><span>$topping</span></div>"; 
                            }
                    ...
                    <?php
                        ...
                        foreach($pizzaMenu as $menuPizza => $price) {
                            echo "<div class='menu-item'>
                                    <div class='menu-item-name'>$menuPizza</div>
                                    <div class='price'>₱$price</div>
                                    </div>";
                        }

                        foreach($toppingsMenu as $menuTopping => $price) {
                            echo "<div class='menu-item'>
                                    <div class='menu-item-name'>$menuTopping</div>
                                    <div class='price'>₱$price</div>
                                    </div>";
                        }
            ...
            <div class="card full-width order-counter">
                ...
                <?php
                    if (isset($_POST['order'])) {
                        ...
                        for ($i = 1; $i <= $qty; $i++) {
                            echo "<div class='order-item'>Order #$i - $pizza for $customer</div>";
                        }
                    }
                ?>
            </div>
